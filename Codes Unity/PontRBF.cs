...
public class PontRBF : MonoBehaviour
{
    ...
    // --- Méthode Start pour les tests ---
    void Start()
    {
        // Décalages pour l'affichage (similaire à PontPMC)
        float posX = 0f;
        float posY = 18f;
        float decalageX = 30f;
        float decalageY = -6f;
    ...
    {
        // ... (Implémentation de l'affichage des axes et du titre)
